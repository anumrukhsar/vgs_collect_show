...
class ShowHomePage extends StatefulWidget {
  ShowHomePage({Key key, this.title,this.cardToken,this.dateToken,this.nameToken,this.cvcToken,this.ssnToken}) : super(key: key);
  final String title;
  final String cardToken;
  final String dateToken;
  final String nameToken;
  final String cvcToken;
  final String ssnToken;
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget _revealButton() {
    return MaterialButton(
      ...
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8.0)),
      color: Colors.blue,
      child: new Text('Go to Reveal Page',
          style: new TextStyle(fontSize: 16.0, color: Colors.white)),
      onPressed: () {
       Navigator.push(context, new MaterialPageRoute(builder: (context)=>ShowHomePage(title: 'Reveal Page',cardToken: cardToken,dateToken:dateToken,nameToken: nameToken,cvcToken: cvcToken,ssnToken: ssnToken,)));
      },
    );
  }
...
Widget _showButton() {
  return MaterialButton(
    ...
    child: new Text('Reveal',
        style: new TextStyle(fontSize: 16.0, color: Colors.white)),
    onPressed: () {
      showController.revealCardAsync(widget.cardToken,widget.nameToken ,widget.dateToken,widget.cvcToken,widget.ssnToken).then((value) {
        final entries = value.entries;
